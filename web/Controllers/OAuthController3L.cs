...
{
    public class OAuthController3L : ControllerBase
    {
        /// <summary>
    ...
    public class Credentials
    {
        ...
        public static async Task<Credentials> CreateFromCodeAsync(string code, IResponseCookies cookies)
        {
            ...
            dynamic credentialInternal = await oauth.GettokenAsync(
              Utils.GetAppSetting("FORGE_CLIENT_ID"), Utils.GetAppSetting("FORGE_CLIENT_SECRET"),
              oAuthConstants.AUTHORIZATION_CODE, code, Utils.GetAppSetting("FORGE_CALLBACK_URL"));
